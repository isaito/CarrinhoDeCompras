...
public class CarrinhoDeCompras {
    ...
    /**
     * Peso máximo que o carrinho suporta. Não mexer no valor!
     */
    private final static int PESO_MAXIMO_CARRINHO = 60;
    /**
     * Arquivo de entrada, onde são descritos todos os problemas. O arquivo faz
     * parte do projeto NetBeans, e portanto é especificado um caminho relativo.
     */
    private final static String ARQUIVO_ENTRADA = "instancias.txt";
    /**
     * Arquivo de saída, onde vão ser escritas as soluções. O arquivo é externo
     ...
     * demorada é a solução. Durante o desenvolvimento, escolha apenas poucas
     * instâncias para não demorar muito. Quando estiver pronto, escolha todos.
     * Exemplo 1: 0-10,15-30,132-133,140,141,142 Exemplo 2: 0-159 (todos)
     */
    ...
    public void executar() throws Exception {
        ...
        for (int i : problemasATestar) {
            ...
            //SolucaoForcaBruta solucao = new SolucaoForcaBruta();
            Date antes = new Date();
            ListaProdutos resposta = SolucaoProgramacaoDinamica.resolver(p, PESO_MAXIMO_CARRINHO);
